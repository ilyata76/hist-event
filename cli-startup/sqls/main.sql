...
(
    '1', 'ссылка на главу с жопой', null, '1',
    null, '{5}', null, null,
    null, null, null, null,
    null, null, null, null,
    null, null
...
(
    '5', 'Аграрная реформа', '5', 'Реформа была крутая, а ещё немного некрутая.', 'Реформа была крутая, потому что назрела. Состояние сельского хозяйство было плачевным. {event:4}[?]. Реформа должна была преследовать цели. Таким образом, был запущен процесс чего-то (ХОД) {source_fragment:1}[абоба] В итоге всё сталок руто но не очень круто (ИТОГИ).', 'EVENT', null, 
    '{4}', '{6}', null, null,
    null, null, null, null,
    null, null, null, null,
    '{1}', null
